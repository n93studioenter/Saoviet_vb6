...
Private Sub LietKeTonKho(mkho As Long, ngay As Date, lk As Integer)
    Dim rs_ton As Recordset, luong As Double, T As Double, dgia As Double, t2 As Double
...
Private Sub XuLyChenhLech(n As Date, mkho As Long)
    Dim rs As Recordset, luong As Double, tien As Double, i As Integer, tien2 As Double
...
Private Sub LietKeKK()
    Dim rs_ton As Recordset, dgia As Double
